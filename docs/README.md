...
- `docs/ko/**` contains Korean translations and Korean originals intended for
  public documentation.

Current product documentation assumes a Windows-only release target. Native
macOS and Linux desktop support is tracked as backlog, while WSL remains a
supported Windows integration.
